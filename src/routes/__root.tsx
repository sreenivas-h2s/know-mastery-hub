  ...
  head: () => ({
    meta: [
      ...
      { title: "SynapseAI — Adaptive Learning Intelligence" },
      {
        name: "description",
        content:
          "An AI tutor that tracks your knowledge state, schedules spaced repetition and gamifies mastery.",
      },
      { name: "author", content: "SynapseAI" },
      { property: "og:title", content: "SynapseAI — Adaptive Learning Intelligence" },
      {
        property: "og:description",
        content: "AI concept maps, spaced repetition and a gamified mastery dashboard.",
      },
